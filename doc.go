...
Format usage:
    ...
    translationEnUS := monday.Format(t, layout, LocaleEnUS)  // Instead of t.Format(layout)
    translationRuRU := monday.Format(t, layout, LocaleRuRU)  // Instead of t.Format(layout)
    ...
...
Parse usage:
    ...
    parsed := monday.ParseInLocation(layout, "12 April 2013 00:00:00 MST", time.UTC, LocaleEnUS)) 
    parsed2 = monday.ParseInLocation(layout, "12 апреля 2013 00:00:00 MST", time.UTC, LocaleRuRU))
    ...
